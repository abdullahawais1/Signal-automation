...
test('Dispatch Window Default Status', async ({ page }) => {
  ...
  // Locate "In Progress" and "Clocked In" options inside dropdown
  const inProgressOption = statusDropdown.locator('div', { hasText: 'In Progress' });
  const clockedInOption = statusDropdown.locator('div', { hasText: 'Clocked In' });
